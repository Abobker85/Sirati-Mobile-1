...
import 'package:sirati/core/utils/app_format.dart';
import 'package:sirati/core/utils/safe_url.dart';
...
import 'package:sirati/shared/widgets/offline_cache_banner.dart';
                        ...
                        children: [
                          ...
                          MotionReveal(
                            ...
                            child: _DashboardActionCard(
                              ...
                              backgroundColor: context.sirati.primaryDark,
                              buttonColor: context.sirati.surface,
                              buttonTextColor: context.sirati.primaryDark,
                              icon: Icons.description_outlined,
...
class _CountUpValueState extends State<_CountUpValue> {
  ...
  Widget build(BuildContext context) {
    ...
    // Render nothing when count is zero or absent (SIRATI-63).
...
class _DashboardActionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final darkText =
        textColor != null || backgroundColor == context.sirati.amber;
    final ink =
        textColor ?? (darkText ? context.sirati.textPrimary : Colors.white);
